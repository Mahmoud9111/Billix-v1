...
import { Apple, AppWindow as Windows, Store as PlayStore } from 'lucide-react';
...
function Aboutus() {
  return (
    ...
    <>
          ...
          <h1 className="text-5xl font-bold text-white mb-4">Our Platforms</h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Experience seamless integration across all your devices with our innovative solutions available on desktop and mobile platforms.
          </p>
        </div>
      ...
      <div className="border border-neutral-600 bg-neutral-950 rounded-3xl p-2">
        ...
        <div className="flex flex-col md:flex-row gap-3 w-full max-w-6xl">
          ...
          <div className="flex-1 relative h-[500px] w-full bg-neutral-900/60 backdrop-blur-xl rounded-[20px] shadow-[0_0_0_0,inset_0_0_30px_rgba(200,200,200,0.1)] border border-neutral-700 text-gray-100 p-4">
            ...
            <div className="w-full h-60 bg-black/50 rounded-lg"></div>
          </div>
        </div>
      </div>
    </div></>
